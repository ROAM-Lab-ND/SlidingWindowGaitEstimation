...
$(BUILDPATH)SSEplainEigen: CPP/main.cpp $(HEADERS)
	$(CC) -std=c++11 -g -O3 -march=native -fsanitize=address $(IPATHS) -D MODE=MODE_PLAIN_EIGEN CPP/main.cpp -o $(BUILDPATH)SSEplainEigen

$(BUILDPATH)SSEtrickEigen: CPP/main.cpp $(HEADERS)
	$(CC) -std=c++11 -g -O3 -march=native -fsanitize=address $(IPATHS) -D MODE=MODE_TRICK_EIGEN CPP/main.cpp -o $(BUILDPATH)SSEtrickEigen
